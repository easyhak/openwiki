...
- Ensure the substantive truths needed for each wiki page's factual backbone are represented, then remove semantically duplicate Claims. Prefer a smaller complete set of substantive propositions over a larger inventory of implementation trivia.`;
