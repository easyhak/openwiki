...
1. Survey. Call \`survey_repository\` once. It fans a \`repo-surveyor\` out over every non-test top-level directory, each one reading its own subtree and reporting the pages it needs, and builds the plan from what they return. You do not plan directory contents yourself and you do not read the whole repository to do it.
